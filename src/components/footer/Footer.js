import './Footer.css';
import nails from '../../assets/Nail_Polish_Emoji_Icon_ios10_grande.png';
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-info">
        ...
        <div className="footer-links">
          <div className="link-heding">Company</div>
          <ul className="link-list">
            <li className="link-item">
              <a href="###" className="link-target">
                Terms & Conditions
        ...
        <div className="footer-links">
          <div className="link-heding">Get in touch</div>
          <ul className="link-list">
            <li className="link-item">
              <a href="###" className="link-target">
      ...
      <div className="all-rights">© 2021 GPT-3. All rights reserved.</div>
      <div className="created">
        ...
        <img src={nails} alt="nails" className="nails"></img>
      </div>
    </footer>
  );
};
